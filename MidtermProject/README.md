...
html>CSS>Responsive>polish>JS>final details
...
# Project Name: [Your Project Title]
        ...
        ## 0. Apology
        Sorry about the general roughness of all this, sickness + ADHD
        is NOT a good combo
        ...
        ## 3. Main Features
        landing page with basic synopsis, character type pages, pages for individual characters (WIP)

        ## 4. Technologies Used
        html-basic structure, css for grid system/slideshows, js for slideshows
